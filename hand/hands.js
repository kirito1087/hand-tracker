...
*/
    ...
    function va(a) {
        this.next = function(b) {
            pa(a.h);
            a.h.j ? b = ta(a, a.h.j.next, b, a.h.u) : (a.h.u(b),
            b = ua(a));
            return b
        }
        ;
        this.throw = function(b) {
            pa(a.h);
            a.h.j ? b = ta(a, a.h.j["throw"], b, a.h.u) : (qa(a.h, b),
            b = ua(a));
            return b
        }
        ;
    ...
    function Kb(a, b, c, d) {
        a.j && (a.j = void 0);
        b >= a.i || d ? Jb(a)[b] = c : (a.o[b + a.G] = c,
        (a = a.B) && b in a && delete a[b])
    }
    function Lb(a, b, c, d) {
        var e = S(a, b);
        ...
        if (d)
            ...
            d = !(c & 2);
            var f = g & 2;
            c & 1 || !f ? d && g & 16 && !f && zb(e, 16) : (e = Ab(Array.prototype.slice.call(e)),
            Kb(a, b, e))
        }
        return e
    }
    ...
    function Nb(a, b, c, d, e) {
        ...
        e || (e = Object.isFrozen(g),
        d && !e ? Object.freeze(g) : !d && e && (g = Array.prototype.slice.call(g),
        a.h[c] = g));
        return g
    }
    function Ob(a, b, c) {
    ...
    function $b(a, b, c, d, e, g, f) {
        if (a = a.h && a.h[c]) {
            ...
            if (null != d) {
                ...
                g = (g ? 8 : 0) | 1;
                a = Q(f);
                (a & g) !== g && (Object.isFrozen(f) && (f = Array.prototype.slice.call(f)),
                R(f, a | g));
                b.h || (b.h = {});
                b.h[c] = d
            } else
    ...
    ;function X(a, b, c) {
        ...
        a: {
            ...
            void 0 !== b && -1 < b ? (this.i = Math.max(b, d + 1 - this.G),
        ...
        if (c) {
            ...
            for (k = 0; k < c.length; k++)
                f = c[k],
                f < e ? (f += this.G,
                (d = a[f]) ? ac(d, b) : a[f] = Fb) : (n || (n = Jb(this)),
                (d = n[f]) ? ac(d, b) : n[f] = Fb)
        }
    }
    ...
    var Y = Ac(function(a, b, c) {
        ...
        if (null != b) {
            ...
            var d = +b;
            0 === d ? 0 < 1 / d ? G = H = 0 : (H = 0,
            G = 2147483648) : isNaN(d) ? (H = 0,
            G = 2147483647) : (d = (c = 0 > d ? -2147483648 : 0) ? -d : d,
            3.4028234663852886E38 < d ? (H = 0,
            G = (c | 2139095040) >>> 0) : 1.1754943508222875E-38 > d ? (d = Math.round(d / Math.pow(2, -149)),
            H = 0,
            G = (c | d) >>> 0) : (b = Math.floor(Math.log(d) / Math.LN2),
            d *= Math.pow(2, -b),
      ...
      , Bc = Ac(function(a, b, c) {
        ...
        b = S(b, c);
        null != b && ("string" === typeof b && Wa(b),
        null != b && (M(a.h, 8 * c),
        "number" === typeof b ? (a = a.h,
        Sa(b),
        sb(a, G, H)) : (c = Wa(b),
        sb(a.h, c.i, c.h))))
    })
      ...
      , Dc = Ac(function(a, b, c) {
        ...
        if (db) {
            ...
            for (var k = null, l, m; h < d; )
                l = a[h++],
                128 > l ? e.push(l) : 224 > l ? h >= d ? K() : (m = a[h++],
                194 > l || 128 !== (m & 192) ? (h--,
                K()) : e.push((l & 31) << 6 | m & 63)) : 240 > l ? h >= d - 1 ? K() : (m = a[h++],
                128 !== (m & 192) || 224 === l && 160 > m || 237 === l && 160 <= m || 128 !== ((g = a[h++]) & 192) ? (h--,
                K()) : e.push((l & 15) << 12 | (m & 63) << 6 | g & 63)) : 244 >= l ? h >= d - 2 ? K() : (m = a[h++],
                128 !== (m & 192) || 0 !== (l << 28) + (m - 144) >> 30 || 128 !== ((g = a[h++]) & 192) || 128 !== ((f = a[h++]) & 192) ? (h--,
                K()) : (l = (l & 7) << 18 | (m & 63) << 12 | (g & 63) << 6 | f & 63,
                l -= 65536,
                e.push((l >> 10 & 1023) + 55296, (l & 1023) + 56320))) : K(),
                8192 <= e.length && (k = ab(k, e),
                e.length = 0);
            h = ab(k, e)
        }
        U(b, c, h);
    ...
    function ed() {
        return E(function(a) {
            ...
            case 1:
                return a.s = 2,
                D(a, WebAssembly.instantiate(ad), 4);
            case 4:
                a.h = 3;
                a.s = 0;
                break;
    ...
    function gd(a) {
        ...
        return E(function(p) {
            ...
            case 2:
                c = p.i;
                if ("object" === typeof window)
                    return cd("createMediapipeSolutionsWasm", {
                    ...
                    l = Promise.all(h.map(function(n) {
                        ...
                        return E(function(w) {
                            if (1 == w.h)
                                return n = window.createMediapipeSolutionsWasm,
                    ...
                    m = function() {
                        return E(function(n) {
                            a.h.graph && a.h.graph.url ? n = D(n, hd(a, a.h.graph.url), 0) : (n.h = 0,
                            n = void 0);
                            return n
                        })
                    }(),
    ...
    function id(a) {
        ...
        return E(function(l) {
            ...
            for (d = c.next(); !d.done; d = c.next())
                e = d.value,
                a.j.overrideFile(e, a.D[e]);
            a.D = {};
            if (a.h.listeners)
                for (g = A(a.h.listeners),
    ...
    x.setOptions = function(a, b) {
        ...
        if (b = b || this.h.options) {
            ...
            h = f.next())
                if (h = h.value,
                !(h in this.l && this.l[h] === a[h])) {
                    this.l[h] = a[h];
                    var k = b[h];
                    void 0 !== k && (k.onChange && (g.X = k.onChange,
                    g.Y = a[h],
                    d.push(function(l) {
                        return function() {
                            var m;
                    ...
                    k.graphOptionXref && (h = Object.assign({}, {
                        calculatorName: "",
                        calculatorIndex: 0
                    }, k.graphOptionXref, {
                        ...
                        a: {
                            ...
                            case "video":
                                ...
                                if ("undefined" !== typeof HTMLVideoElement && n instanceof HTMLVideoElement) {
                                    ...
                                    "undefined" !== typeof HTMLImageElement && n instanceof HTMLImageElement ? (t = n.naturalWidth,
                                    w = n.naturalHeight) : (t = n.width,
                                    w = n.height);
                                w = {
                                    glName: q.m,
                                    width: t,
    ...
    function md(a, b, c) {
        var d;
        return E(function(e) {
            return "number" === typeof c || c instanceof Uint8Array || c instanceof a.i.Uint8BlobList ? e.return(c) : c instanceof a.i.Texture2dDataOut ? (d = a.v[b],
            d || (d = new Xc(a.i,a.K),
            a.v[b] = d),
            e.return(Yc(d, c, a.M))) : e.return(void 0)
        })
    }
    function jd(a, b) {
